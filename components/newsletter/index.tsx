        ...
        <div className="p-4 sm:p-10 mx-auto">
            ...
            <form className="flex flex-wrap justify-between gap-5">
                <input
                    ...
                    className="h-16 flex-shrink-0 flex-grow px-4 rounded-lg"
                />
                <input
                    type="submit"
                    value="Subscribe"
                    className="bg-lavender border-2 border-lavender font-title text-2xl uppercase py-3 px-4 rounded-lg cursor-pointer text-white flex-grow flex-shrink-0 w-full sm:w-auto"
                />
            </form>
        </div>
    );
